...
// Converts a Published Datetime (in JS Date object format), Content Type, and Content Ordinal into a shortened URL fragment.
...
function expand(fragment, dateFormat) {
  ...
  if(fragment.charAt(1) == '/') {
    ...
    ordinal = fragment.substr(5)
  } else {
    sxg = fragment.substr(1,3);
    ordinal = fragment.substr(4)
  }

  // Convert Sexagesimal into Date Object
  var dateObj = NewBase60.SxgToDate(sxg);
